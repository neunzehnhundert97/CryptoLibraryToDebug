...
public class Gui extends JFrame
{
	...
	public Gui()
	{
		...
		button2.setBounds(10, 100, 100, 100);
		...
		{ "Hallo", "Tshüss" });
		this.add(box);
		box.setBounds(100, 400, 200, 50);

		this.add(pane);
		pane.setBounds(100, 300, 200, 50);
	...
	private void setup()
	{
		...
		algorithm_categories_comboBox.setPreferredSize(new Dimension(500, 100));
